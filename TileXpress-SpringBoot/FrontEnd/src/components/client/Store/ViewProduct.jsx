        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex items-center justify-between gap-x-8 mt-8">
              ...
              <button
                onClick={() => navigate('/tile-calculator', {
                  state: {
                    tileWidth: size.split('X')[0],
                    tileHeight: size.split('X')[1]
                  }
                })}
                className="block w-full text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded"
              >
                Calculate Tiles
              </button>
